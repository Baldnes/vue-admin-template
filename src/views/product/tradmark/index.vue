<template>
  <el-card class="box-card">
    <!--    添加按钮-->
    <el-button type="success" size="default" icon="Plus" @click="addTrademark">添加品牌</el-button>
    <!--    表格-->
    <el-table style="margin: 10px 0" border :data="trademarkArr">
      ...
      <el-table-column label="品牌操作">
        <template #="{row,$index}">
          ...
          <el-popconfirm :title="`您确定删除${row.tmName}吗？`" width="250px" @confirm="removeTrademark(row.id)">
            <template #reference>
  ...
  <!--  对话框-->
  <el-dialog v-model="dialogFormVisible" :title="trademarkParmas.id?'修改品牌':'添加品牌'">
    <el-form style="width: 80%;" label-width="120px" :model="trademarkParmas" :rules="rules" ref="formRef">
...
import {Records, TrademarkData, TrademarkResponseData} from "@/api/product/trademark/type.ts";
